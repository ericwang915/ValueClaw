...
class TestChunker:
    def test_basic_paragraph_split(self):
        from value_claw.core.retrieval.chunker import chunk_text
    ...
    def test_load_corpus_from_directory(self, tmp_path):
        from value_claw.core.retrieval.chunker import load_corpus_from_directory
...
class TestBM25Retriever:
    def test_retrieve_returns_relevant(self):
        from value_claw.core.retrieval.sparse import BM25Retriever
...
class TestEmbeddingRetriever:
    def test_retrieve_returns_results(self):
        from value_claw.core.retrieval.dense import EmbeddingRetriever
        corpus = make_corpus(SAMPLE_TEXTS)
...
class TestRRF:
    def test_combines_two_lists(self):
        from value_claw.core.retrieval.fusion import reciprocal_rank_fusion
...
class TestLLMReranker:
    def test_reranks_by_llm_response(self):
        from value_claw.core.retrieval.reranker import LLMReranker
        corpus = make_corpus(SAMPLE_TEXTS)
...
class TestHybridRetriever:
    def test_sparse_only(self):
        from value_claw.core.retrieval.retriever import HybridRetriever
        corpus = make_corpus(SAMPLE_TEXTS)
...
class TestKnowledgeRAG:
    def test_load_and_retrieve(self, tmp_path):
        from value_claw.core.knowledge.rag import KnowledgeRAG
    ...
    def test_simplerag_alias(self, tmp_path):
        from value_claw.core.knowledge.rag import SimpleRAG
...
class TestMemoryManagerRAG:
    def _make_manager(self, tmp_path):
        from value_claw.core.memory.manager import MemoryManager
