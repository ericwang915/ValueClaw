#!/usr/bin/env python3
"""Parse and summarise value_claw usage from history_detail.jsonl."""
import argparse
import json
import os
import sys
...
def main():
    ...
    log_path = args.log
    if not log_path:
        home = os.environ.get("VALUE_CLAW_HOME", os.path.expanduser("~/.value_claw"))
    ...
    if args.format == "json":
        ...
        print("value_claw Usage Statistics")
        print(f"{'=' * 40}")
