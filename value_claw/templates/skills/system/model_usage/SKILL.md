...
The `history_detail.jsonl` file under `~/.value_claw/context/logs/` contains
...
```bash
python {skill_path}/usage_stats.py --log ~/.value_claw/context/logs/history_detail.jsonl
```
...
wc -l ~/.value_claw/context/logs/history_detail.jsonl

# Recent entries
tail -5 ~/.value_claw/context/logs/history_detail.jsonl | python -m json.tool
```
