"""
Heartbeat monitor for value_claw.
...
Configuration (value_claw.json or env vars)
-------------------------------------------
    ...
    def __init__(
        ...
        if log_path is None:
            try:
                ...
                log_path = os.path.join(os.path.expanduser("~/.value_claw"), "context", "logs", "heartbeat.log")
...
def _build_file_logger(log_path: str) -> logging.Logger:
    ...
    file_logger = logging.getLogger("value_claw.heartbeat.file")
...
def create_heartbeat(
    ...
    """Create a HeartbeatMonitor from value_claw.json / env vars."""
