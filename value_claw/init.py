"""
Project initialiser for value_claw.
...
def init(project_path: str | None = None) -> None:
    ...
    print(f"Initialising value_claw in: {application_dir}")
