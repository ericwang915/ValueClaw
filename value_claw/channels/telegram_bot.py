"""
Telegram channel for value_claw.
...
class TelegramBot:
    ...
    async def _cmd_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        await update.message.reply_text(
            "\U0001f44b Hi! I'm your value_claw agent.\n\n"
    ...
    _BOT_COMMANDS = [
        ...
        BotCommand("cashout", "Withdraw cash: /cashout <amount>"),
    ]
...
def create_bot(session_manager: "SessionManager") -> TelegramBot:
    """Create a TelegramBot from value_claw.json / env vars."""
