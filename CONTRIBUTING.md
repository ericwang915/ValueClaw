# Contributing to value_claw

Thank you for your interest in contributing to value_claw! We welcome contributions of all kinds — bug fixes, new features, documentation improvements, and more.

## Getting Started

```bash
git clone https://github.com/ericwang915/value_claw.git
cd value_claw
...
### Reporting Bugs
- Search [existing issues](https://github.com/ericwang915/value_claw/issues) first.
...
- Use [Ruff](https://github.com/astral-sh/ruff) for linting: `ruff check value_claw/`
- Use meaningful variable names.
- Avoid redundant comments — code should be self-documenting.

## Adding New Skills

1. Create a directory under `value_claw/templates/skills/<category>/<skill_name>/`.
...
1. Create a new file in `value_claw/core/llm/`.
...
1. Create a new file in `value_claw/channels/`.
...
Thanks for helping make value_claw better!
